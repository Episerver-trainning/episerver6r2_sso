<%@ Page Language="C#" MasterPageFile="~/Templates/AlloyTech/MasterPages/MasterPage.master" AutoEventWireup="False" CodeBehind="Login.aspx.cs" Inherits="EPiServer.Templates.AlloyTech.Pages.Login"%>
<%@ Register TagPrefix="AlloyTech" TagName="ForgotPassword"	Src="~/Templates/AlloyTech/Units/Static/ForgotPassword.ascx" %>
<%@ Register TagPrefix="AlloyTech" TagName="ChangePassword"	Src="~/Templates/AlloyTech/Units/Static/ChangePassword.ascx" %>
