<%@ Page Language="C#" MasterPageFile="~/Templates/AlloyTech/MasterPages/MasterPage.master" Codebehind="Search.aspx.cs" Inherits="EPiServer.Templates.AlloyTech.Pages.SearchPage" %>
...
<asp:Content ContentPlaceHolderID="MainBodyRegion" runat="server">
    ...
    <div id="MainBody">
        ...
        <div id="SearchArea">
            <asp:Label ID="SearchLabel" CssClass="hidden" runat="server" AssociatedControlID="SearchText" Text="<%$ Resources: EPiServer, search.searchstring %>" />
        ...
        <div id="ResultArea">
            ...
            <asp:Repeater ID="SearchResult" DataSourceID="SearchDataSource" runat="server" Visible="false">
                ...
                <ItemTemplate>
                    <li>
                        <a href="<%# GetLinkUrlWithLanguage(Container.DataItem as PageData) %>">
                            <EPiServer:Property runat="server" PropertyName="PageName" />
                        </a>
                        (<span class="dateTime" runat="server"><%# DataBinder.Eval(Container.DataItem, "Changed", "{0:d}")%></span>)
                        <p>
