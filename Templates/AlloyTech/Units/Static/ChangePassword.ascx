<%@ Control Language="C#" AutoEventWireup="False" CodeBehind="ChangePassword.ascx.cs" Inherits="EPiServer.Templates.AlloyTech.Units.Static.ChangePassword" %>
<asp:LinkButton OnClick="ToggleChangePass_Click" Text="<%$ Resources: EPiServer, usersettings.changepassword %>" runat="server" />
<asp:ChangePassword CssClass="changePassArea" ID="changePassArea" Visible="false" runat="server">
